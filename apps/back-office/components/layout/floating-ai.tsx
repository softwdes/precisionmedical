...
export function FloatingAI(): React.ReactElement {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 px-3 py-1.5 rounded-md bg-bg-3 text-xs text-text-1 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none border border-border">
        AI Assistant
      </span>
    </button>
  );
