    ...
    <>
      <style>{`
        ...
        .tc-btn:hover:not(:disabled) {
          ...
          box-shadow: 0 12px 36px rgba(16,185,129,0.65) !important;
        }
      ...
      <div style={{
        ...
        {/* Scanlines */}
        <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0, background: 'repeating-linear-gradient(180deg, transparent, transparent 39px, rgba(16,185,129,0.018) 40px)' }} />
        ...
        <div style={{
          ...
          background: 'linear-gradient(90deg, transparent 0%, rgba(16,185,129,0.07) 35%, rgba(99,102,241,0.07) 65%, transparent 100%)',
        }} />

        {/* Floating particles */}
        <div style={{ position:'absolute', top:'15%',  left:'10%',  width:3, height:3, borderRadius:'50%', background:'rgba(16,185,129,0.42)',  pointerEvents:'none', zIndex:0, animation:'particlePulse 3.0s ease-in-out infinite 0ms' }} />
        <div style={{ position:'absolute', top:'22%',  right:'14%', width:2, height:2, borderRadius:'50%', background:'rgba(99,102,241,0.35)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 2.5s ease-in-out infinite 400ms' }} />
        <div style={{ position:'absolute', top:'72%',  left:'7%',   width:2, height:2, borderRadius:'50%', background:'rgba(16,185,129,0.30)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 3.5s ease-in-out infinite 800ms' }} />
        <div style={{ position:'absolute', top:'65%',  right:'9%',  width:3, height:3, borderRadius:'50%', background:'rgba(99,102,241,0.28)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 4.0s ease-in-out infinite 1200ms' }} />
        <div style={{ position:'absolute', top:'38%',  left:'4%',   width:2, height:2, borderRadius:'50%', background:'rgba(16,185,129,0.25)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 2.8s ease-in-out infinite 1600ms' }} />
        <div style={{ position:'absolute', top:'85%',  right:'18%', width:2, height:2, borderRadius:'50%', background:'rgba(16,185,129,0.22)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 3.2s ease-in-out infinite 2000ms' }} />
        <div style={{ position:'absolute', top:'18%',  left:'30%',  width:2, height:2, borderRadius:'50%', background:'rgba(99,102,241,0.22)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 3.8s ease-in-out infinite 2400ms' }} />
        <div style={{ position:'absolute', top:'78%',  right:'35%', width:3, height:3, borderRadius:'50%', background:'rgba(16,185,129,0.20)',   pointerEvents:'none', zIndex:0, animation:'particlePulse 2.6s ease-in-out infinite 2800ms' }} />
        ...
        <div style={{ position:'relative', zIndex:1, display:'flex', flexDirection:'column', alignItems:'center', width:'100%', maxWidth:480, overflow:'visible' }}>
          ...
          {/* Ambient glows */}
          <div className="tc-glow-1" style={{ position:'absolute', top:-160, right:-100, width:380, height:380, borderRadius:'50%', background:'radial-gradient(circle, rgba(16,185,129,0.18) 0%, rgba(16,185,129,0.06) 45%, transparent 65%)', pointerEvents:'none', zIndex:0 }} />
          <div className="tc-glow-2" style={{ position:'absolute', bottom:-120, left:-140, width:320, height:320, borderRadius:'50%', background:'radial-gradient(circle, rgba(99,102,241,0.14) 0%, transparent 60%)', pointerEvents:'none', zIndex:0 }} />
          <div style={{ position:'absolute', top:'50%', left:'50%', transform:'translate(-50%,-50%)', width:500, height:500, borderRadius:'50%', background:'radial-gradient(circle, rgba(16,185,129,0.05) 0%, transparent 65%)', pointerEvents:'none', zIndex:0 }} />
          ...
          <div style={{ position:'relative', zIndex:1, textAlign:'center', marginBottom:'2.25rem', animation:'fadeUp 600ms cubic-bezier(0.16,1,0.3,1) both' }}>
            <div style={{ position:'relative', display:'inline-flex', alignItems:'center', justifyContent:'center', marginBottom:'0.75rem' }}>
              {/* Rings */}
              <div style={{ position:'absolute', top:-24, left:-24, right:-24, bottom:-24, borderRadius:40, border:'1px solid rgba(16,185,129,0.05)' }} />
              <div style={{ position:'absolute', top:-16, left:-16, right:-16, bottom:-16, borderRadius:32, border:'1px solid rgba(16,185,129,0.10)' }} />
              <div style={{ position:'absolute', top:-8,  left:-8,  right:-8,  bottom:-8,  borderRadius:24, border:'1px solid rgba(16,185,129,0.22)' }} />
              {/* Logo box */}
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 40px rgba(16,185,129,0.65), 0 0 80px rgba(16,185,129,0.25)',
          ...
          <div style={{ position:'relative', zIndex:1, width:420, maxWidth:'90vw' }}>
            ...
            <div style={{
              ...
              borderRadius:21,
              background:'linear-gradient(135deg, rgba(16,185,129,0.40), rgba(16,185,129,0.16) 50%, rgba(99,102,241,0.28) 100%)',
              pointerEvents:'none', zIndex:0,
            }} />
            {/* Card */}
            <div style={{
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="tc-field" style={{ position:'relative', display:'flex', alignItems:'center', gap:10, borderBottom:'1px solid rgba(255,255,255,0.07)', padding:'14px 0', marginBottom:4 }}>
                  <Lock size={17} color="#10B981" style={{ flexShrink:0 }} />
                  <input
                    className="tc-input"
                  ...
                  <div style={{ position:'absolute', bottom:-4, left:0, right:0, height:8, background:'linear-gradient(180deg, rgba(16,185,129,0.12), transparent)', borderRadius:'0 0 4px 4px', pointerEvents:'none' }} />
                </div>
                ...
                <button
                  ...
                  style={{
                    ...
                    padding:16,
                    textAlign:'center',
                    boxShadow:'0 10px 36px rgba(16,185,129,0.55), 0 4px 14px rgba(16,185,129,0.28)',
                    color:'white',
                    fontWeight:700,
                    fontSize:15,
