...
export const CITIES_BY_STATE: Record<string, string[]> = {
  ...
  // Shelbyville la pidió el mostrador el 17-sep por una paciente real. Ojo con
  // la tentación de seguir completando estados de afuera: el 92% de los
  // pacientes son de Utah y los 356 restantes están repartidos en casi tantas
  // ciudades distintas como personas (41 en California viven en 34 ciudades).
  // Para esos está la opción de escribirla a mano, que es la que tiene que
  // funcionar siempre.
  TN: ['Chattanooga','Clarksville','Jackson','Johnson City','Kingsport','Knoxville','Memphis','Murfreesboro','Nashville','Shelbyville'],
  ...
  UT: ['Alpine','Alta','Altamont','Alton','Amalga','American Fork','Annabella','Antimony','Aurora','Beaver','Benjamin','Benson','Blanding','Bluffdale','Boulder','Bountiful','Brian Head','Brigham City','Castle Dale','Cedar City','Cedar Hills','Centerfield','Centerville','Charleston','Circleville','Clarkston','Clawson','Clearfield','Clinton','Coalville','Copperton','Corinne','Cornish','Cottonwood Heights','Dammeron Valley','Daniel','Delta','Draper','Duchesne','Eagle Mountain','East Carbon','Eden','Elk Ridge','Elmo','Elsinore','Elwood','Emery','Emigration Canyon','Enoch','Enterprise','Ephraim','Erda','Escalante','Eureka','Fairfield','Fairview','Farmington','Farr West','Ferron','Fillmore','Fountain Green','Francis','Fruit Heights','Garland','Genola','Glendale','Glenwood','Goshen','Granite','Grantsville','Green River','Gunnison','Harrisville','Heber City','Helper','Herriman','Highland','Hildale','Holden','Holladay','Honeyville','Hooper','Huntington','Huntsville','Hurricane','Hyde Park','Hyrum','Independence','Ivins','Jensen','Joseph','Junction','Kamas','Kanab','Kanarraville','Kaysville','Kearns','Lake Point','Layton','Leamington','Leeds','Lehi','Levan','Lewiston','Lindon','Logan','Lyman','Lynndyl','Magna','Manti','Mantua','Mapleton','Marysvale','Mayfield','Meadow','Mendon','Midvale','Midway','Milford','Millcreek','Millville','Minersville','Moab','Mona','Monroe','Monticello','Morgan','Moroni','Mount Pleasant','Murray','Myton','Naples','Nephi','New Harmony','Newton','North Logan','North Ogden','North Salt Lake','Oak City','Oakley','Ogden','Ophir','Orangeville','Orderville','Orem','Panguitch','Park City','Parowan','Payson','Peoa','Perry','Plain City','Pleasant Grove','Pleasant View','Price','Providence','Provo','Randolph','Richfield','Richmond','River Heights','Riverdale','Riverton','Rocky Ridge','Roosevelt','Roy','Rush Valley','Salem','Salina','Salt Lake City','Sandy','Santa Clara','Santaquin','Saratoga Springs','Scipio','Sigurd','Smithfield','South Jordan','South Ogden','South Salt Lake','South Weber','Spanish Fork','Springdale','Springville','St. George','Stansbury Park','Sterling','Stockton','Sunnyside','Sunset','Syracuse','Taylorsville','Tooele','Toquerville','Tremonton','Trenton','Uintah','Vernal','Vernon','Vineyard','Virgin','Wanship','Washington','Washington Terrace','Wellington','Wellsville','Wendover','West Bountiful','West Haven','West Jordan','West Point','West Valley City','White City','Willard','Woodland Hills','Woods Cross'],
