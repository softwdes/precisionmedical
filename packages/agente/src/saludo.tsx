 ...
 *
 * Viven ACÁ y no en el botón porque quien los ESCUCHA es este componente, y
 * ahora el botón puede estar en cualquiera de los tres portales. Que el que
 * escucha sea el dueño del nombre evita que una app cambie la cadena y las
 * otras dejen de enterarse en silencio.
 */
