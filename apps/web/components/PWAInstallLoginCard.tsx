...
export function PWAInstallLoginCard(): React.ReactElement | null {
    ...
    return (
      <div style={{ marginTop: '1.25rem', width: 420, maxWidth: '90vw', position: 'relative', zIndex: 1 }}>
        <div style={{ position: 'relative' }}>
          <div style={{ position: 'absolute', top: -1, left: -1, right: -1, bottom: -1, borderRadius: 15, background: 'linear-gradient(135deg,rgba(99,102,241,0.35),rgba(139,92,246,0.14) 50%,rgba(6,182,212,0.24) 100%)', pointerEvents: 'none' }} />
          <div style={{ position: 'relative', background: 'rgba(10,14,26,0.90)', borderRadius: 14, padding: '12px 16px', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 32, height: 32, borderRadius: 9, background: 'rgba(99,102,241,0.20)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: 'inset 0 0 0 1px rgba(99,102,241,0.22)' }}>
  ...
  if (event) {
    return (
      <div style={{ marginTop: '1.25rem', width: 420, maxWidth: '90vw', position: 'relative', zIndex: 1 }}>
        <div style={{ position: 'relative' }}>
          <div style={{ position: 'absolute', top: -1, left: -1, right: -1, bottom: -1, borderRadius: 15, background: 'linear-gradient(135deg,rgba(99,102,241,0.40),rgba(139,92,246,0.16) 50%,rgba(6,182,212,0.28) 100%)', pointerEvents: 'none' }} />
          <div style={{ position: 'relative', background: 'rgba(10,14,26,0.92)', borderRadius: 14, padding: '12px 14px', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', display: 'flex', alignItems: 'center', gap: 11 }}>
            <div style={{ width: 34, height: 34, borderRadius: 9, background: 'rgba(99,102,241,0.22)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: 'inset 0 0 0 1px rgba(99,102,241,0.25)' }}>
  ...
  return (
    <div style={{ marginTop: '1.25rem', width: 420, maxWidth: '90vw', position: 'relative', zIndex: 1 }}>
      <div style={{ position: 'relative' }}>
        <div style={{ position: 'absolute', top: -1, left: -1, right: -1, bottom: -1, borderRadius: 15, background: 'linear-gradient(135deg,rgba(99,102,241,0.30),rgba(6,182,212,0.20) 100%)', pointerEvents: 'none' }} />
        <div style={{ position: 'relative', background: 'rgba(10,14,26,0.90)', borderRadius: 14, padding: '12px 16px', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', display: 'flex', alignItems: 'center', gap: 12 }}>
